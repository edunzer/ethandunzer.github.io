...
def main():
    ...
    while play_again:
        ...
        words = ["hangman", "chairs", "backpack", "bodywash", "clothing", "jarod", "santa",
                 "computer", "python", "program", "glasses", "sweatshirt", "project", "computer",
                 "sweatpants", "mattress", "friends", "clocks", "biology", "laptop", "table", "dead",
                 "algebra", "suitcase", "knives", "ninjas", "shampoo", "chris" , "ben", "alex", "carson",
                 "matt", "table", "chair", "pencil", "monitor", "light", "clock", "phone", "door", "window",
                 "table", "kill", "mug", "pole", "art", "wall", "shelves", "portfolio", "keyboard", "raspberry"
                 ]
...
""")
        ...
        print("The lenght of the word is: ")
        print(word_count)
